...
('jdoe', '$2b$12$yQypgNQ8pkScJVMapgwHCuffOFNGo4gzsvcTaMWoprzScB1vXwqX2', 'John', 'Doe', '123-456-7890', '2024-01-01 10:00:00', '2024-05-01 12:00:00'),
('asmith', '$2b$12$k69hgGrqK6RWy9ISae5wKe.ty5ZQMw0e8fByCTCV1NnAkMSRSk1Zq', 'Alice', 'Smith', '987-654-3210', '2024-02-15 08:30:00', '2024-05-10 15:45:00'),
('bwhite', '$2b$12$RGNVHGXUSEyyZ2G3wPBvO.mq/Ts4mg/Rm8rp37ClK9aBqEw2SkrT6', 'Bob', 'White', '456-789-0123', '2024-03-20 09:15:00', '2024-05-15 14:30:00'),
('cjones', '$2b$12$IeA6rwMhYulJScG9wMrryudfsraQ9.Ca6eHOSqyZ6F8Kh/B8mEUcC', 'Carol', 'Jones', '789-012-3456', '2024-04-10 11:45:00', '2024-05-20 10:20:00'),
('dlee', '$2b$12$FOCvBeQsZ2CTCBiHadz3GOuBlXCcOv61bty43E09324TOcDB3AwBW', 'David', 'Lee', '321-654-0987', '2024-05-01 07:50:00', '2024-05-18 08:00:00'),
('ewilliams', '$2b$12$lRRAnFWnwaaxMIu1gCDoQeTbclxLNoR15pHeDTvIWI9UEXeP2ShYm', 'Emma', 'Williams', '159-753-4862', '2024-05-03 10:25:00', '2024-05-18 09:10:00'),
('fgarcia', '$2b$12$Xbkv9S4.D1fBDMB6b3.16.FSdeJH069PdjL28IES4JlYJ3CjNpnce', 'Frank', 'Garcia', '951-357-6248', '2024-05-05 12:45:00', '2024-05-19 11:25:00'),
('gharris', '$2b$12$I9LJaNiYAaalMca0wzbQNepSXeGxV0qeS6.8E0OsmQb8TM24Os/iC', 'Grace', 'Harris', '753-951-8524', '2024-05-07 14:15:00', '2024-05-20 13:00:00'),
('hmartin', '$2b$12$EhnfbZ.2qYcysgLe5hwoo.KRCNdAf.3voI0jDLM30o6ZSm9xH4/ca', 'Hannah', 'Martin', '654-123-7890', '2024-05-09 16:30:00', '2024-05-21 15:45:00');
...
('gharris', 'fgarcia', 'Sure Frank, I will send it by noon.', '2022-02-20 09:15:00-07', NULL),
...
('asmith', 'gharris', 'Grace, can you review the presentation slides?', '2023-01-15 10:00:00-07', NULL),
('gharris', 'asmith', 'Alice, I have reviewed them. Looks good.', '2023-01-15 10:30:00-07', NULL),
...
('dlee', 'bwhite', 'Bob, can you send me the latest data?', '2023-05-15 12:00:00-07', NULL),
...
('cjones', 'ewilliams', 'Yes Emma, let’s meet at 2 PM.', '2023-06-10 14:30:00-07', NULL),
('gharris', 'hmartin', 'Hannah, did you receive my message?', '2023-07-20 08:00:00-07', NULL),
('hmartin', 'gharris', 'Yes Grace, I received it.', '2023-07-20 08:10:00-07', '2023-07-20 08:15:00-07'),
('jdoe', 'asmith', 'Alice, can you join the call at 3 PM?', '2023-08-25 15:00:00-07', NULL),
...
('ewilliams', 'jdoe', 'John, can you review the new proposal?', '2023-10-15 13:00:00-07', NULL),
('jdoe', 'ewilliams', 'Sure Emma, I will review it today.', '2023-10-15 13:10:00-07', NULL),
('gharris', 'cjones', 'Carol, are you available for a quick chat?', '2023-11-20 11:00:00-07', NULL),
('cjones', 'gharris', 'Yes Grace, let’s chat now.', '2023-11-20 11:10:00-07', NULL),
('hmartin', 'asmith', 'Alice, can you send me the latest report?', '2023-12-15 16:00:00-07', NULL),
